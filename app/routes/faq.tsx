...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    { name: "description", content: "Common questions about AuDHD coaching, diagnosis requirements, and what makes neurodivergent coaching different from traditional approaches." },
  ];
}
    ...
    <>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="space-y-8">
            ...
            <div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
              <h2 className="text-xl md:text-2xl font-semibold text-text-primary mb-4">"What's the difference between coaching and therapy?"</h2>
              <div className="space-y-4 text-text-secondary">
                <p className="text-base leading-relaxed">Great question! Here's my take:</p>
            ...
            {/* Question 2 */}
            <div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
              <h2 className="text-xl md:text-2xl font-semibold text-text-primary mb-4">"Do I need an official diagnosis?"</h2>
              <div className="space-y-4 text-text-secondary">
                <p className="text-base leading-relaxed font-semibold">Absolutely not.</p>
                <p className="text-base leading-relaxed">
            ...
            {/* Question 3 */}
            <div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
              <h2 className="text-xl md:text-2xl font-semibold text-text-primary mb-4">"What if I'm not sure I'm autistic/ADHD/AuDHD?"</h2>
              <div className="space-y-4 text-text-secondary">
                <p className="text-base leading-relaxed">That's okay! Questioning is part of the journey.</p>
                <p className="text-base leading-relaxed">
            ...
            {/* Question 4 */}
            <div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
              <h2 className="text-xl md:text-2xl font-semibold text-text-primary mb-4">"How is your coaching different from neurotypical coaching?"</h2>
              <div className="space-y-4 text-text-secondary">
                <p className="text-base leading-relaxed">Where do I start?</p>
                <ul className="space-y-2">
                  <li className="flex items-start space-x-3">
                    <span className="text-primary mt-1">•</span>
                    <span className="text-base leading-relaxed">I won't tell you to "just trust the process" when the process wasn't built for your brain</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <span className="text-primary mt-1">•</span>
                    <span className="text-base leading-relaxed">I understand that sometimes you need scripts, not "intuition"</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <span className="text-primary mt-1">•</span>
                    <span className="text-base leading-relaxed">I know that "just do it" isn't helpful when executive dysfunction has you stuck</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <span className="text-primary mt-1">•</span>
                    <span className="text-base leading-relaxed">I get that some days, showering IS the achievement</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <span className="text-primary mt-1">•</span>
                    <span className="text-base leading-relaxed">I won't shame you for your coping mechanisms (yes, even the "weird" ones)</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <span className="text-primary mt-1">•</span>
                    <span className="text-base leading-relaxed">I understand the both/and of AuDHD, not just autism OR ADHD</span>
                  </li>
                </ul>
                <p className="text-base leading-relaxed">
            ...
            {/* Question 5 */}
            <div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
              <h2 className="text-xl md:text-2xl font-semibold text-text-primary mb-4">"What happens in the free discovery call?"</h2>
              <div className="space-y-4 text-text-secondary">
                <p className="text-base leading-relaxed">
            ...
            {/* Question 6 */}
            <div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
              <h2 className="text-xl md:text-2xl font-semibold text-text-primary mb-4">"What if I need to cancel last minute?"</h2>
              <div className="space-y-4 text-text-secondary">
                <p className="text-base leading-relaxed">Life happens. Especially AuDHD life.</p>
                <p className="text-base leading-relaxed">
            ...
            {/* Question 7 */}
            <div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
              <h2 className="text-xl md:text-2xl font-semibold text-text-primary mb-4">"Can you help with workplace accommodations?"</h2>
              <div className="space-y-4 text-text-secondary">
                <p className="text-base leading-relaxed">Yes! This is a common focus area. We can work on:</p>
                <ul className="space-y-2">
                  <li className="flex items-start space-x-3">
                    <span className="text-primary mt-1">•</span>
                    <span className="text-base leading-relaxed">Figuring out what accommodations you actually need</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <span className="text-primary mt-1">•</span>
                    <span className="text-base leading-relaxed">Scripts for talking to HR or your manager</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <span className="text-primary mt-1">•</span>
                    <span className="text-base leading-relaxed">Strategies for when formal accommodations aren't possible</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <span className="text-primary mt-1">•</span>
                    <span className="text-base leading-relaxed">Building sustainable work habits that honor your neurotype</span>
                  </li>
                </ul>
                <p className="text-base leading-relaxed">
            ...
            {/* Question 8 */}
            <div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
              <h2 className="text-xl md:text-2xl font-semibold text-text-primary mb-4">"Do you work with family members or partners?"</h2>
              <div className="space-y-4 text-text-secondary">
                <p className="text-base leading-relaxed">
                ...
                <p className="text-base leading-relaxed">These sessions focus on:</p>
                <ul className="space-y-2">
                  <li className="flex items-start space-x-3">
                    <span className="text-primary mt-1">•</span>
                    <span className="text-base leading-relaxed">Understanding neurodivergent communication styles</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <span className="text-primary mt-1">•</span>
                    <span className="text-base leading-relaxed">Learning how to support without enabling masking</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <span className="text-primary mt-1">•</span>
                    <span className="text-base leading-relaxed">Building a relationship that works for both neurotypes</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            {/* Question 9 */}
            <div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
              <h2 className="text-xl md:text-2xl font-semibold text-text-primary mb-4">"What's your cancellation policy?"</h2>
              <div className="space-y-4 text-text-secondary">
                <p className="text-base leading-relaxed">
            ...
            {/* Question 10 */}
            <div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
              <h2 className="text-xl md:text-2xl font-semibold text-text-primary mb-4">"How long do people typically work with you?"</h2>
              <div className="space-y-4 text-text-secondary">
                <p className="text-base leading-relaxed">
            ...
            {/* Question 11 */}
            <div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
              <h2 className="text-xl md:text-2xl font-semibold text-text-primary mb-4">"What if I'm too overwhelmed to even start?"</h2>
              <div className="space-y-4 text-text-secondary">
                <p className="text-base leading-relaxed">
      ...
      <section className="py-16 md:py-24 bg-surface-alt">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h2 className="text-2xl md:text-3xl font-semibold tracking-tight text-text-primary mb-6">Still Have Questions?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/book-call" className="inline-flex items-center px-6 py-3 bg-primary text-white rounded-lg font-medium transition-colors duration-200 hover:bg-primary-hover focus:outline-none focus:ring-4 focus:ring-primary/20">
