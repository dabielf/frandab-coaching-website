					...
					<div className="space-y-6">
						<div className="flex sm:flex-row gap-4 sm:gap-8">
							<BodyBase>
								...
								<br />
								<br />
								<strong>At 40, I finally got my answer: I'm AuDHD.</strong>
							</BodyBase>
							<img
						...
						<ul className="space-y-3">
							<li className="flex items-start space-x-3">
								...
								<BodyBase>
									Why I could mediate complex conflicts but couldn't handle
									grocery stores
								</BodyBase>
							</li>
							<li className="flex items-start space-x-3">
								<span className="text-primary mt-1">•</span>
								<BodyBase>
									Why my clients kept saying "you just GET it" when I'd never
									quite gotten myself
								</BodyBase>
							</li>
							<li className="flex items-start space-x-3">
								<span className="text-primary mt-1">•</span>
								<BodyBase>
									Why I'd built an entire career around making the complex
									simple—because my brain literally couldn't handle unnecessary
									complexity
								</BodyBase>
							</li>
							<li className="flex items-start space-x-3">
								<span className="text-primary mt-1">•</span>
								<BodyBase>
									Why I'd always felt like a translator between worlds, never
				...
				<Container>
					...
					<div className="space-y-6">
						<BodyBase>
							...
							assumptions. "Just follow your inner wisdom!" they say. But what
							if your inner wisdom was shaped by 40 years of masking? "Trust the
							process!" they insist. But what if the process was never designed
							for brains like ours?
						</BodyBase>
						<BodyBase>
							This is why I walked away from pursuing ICF certification. Not
							because I don't value professional development, but because their
							approach assumes a neurotypical baseline. For those of us
							diagnosed late, we need more than someone who asks good questions.
							We need someone who understands that our "inner wisdom" might be
							buried under decades of compensatory strategies.
						</BodyBase>
						<BodyBase>
							Sometimes you need a guide who's walked this path. Sometimes you
							need someone to teach you what you never had the chance to learn.
							Sometimes you need validation that your struggles aren't moral
							failings—they're the natural result of living in a world that
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						<div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
							...
							<BodyBase className="text-text-secondary">
								Two years post-diagnosis, I'm still learning what it means to
								live authentically AuDHD. I bring both the fresh perspective of
								recent discovery and the wisdom of four decades of unknowing
								adaptation.
							</BodyBase>
						</div>
						...
						<div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
							...
							<BodyBase className="text-text-secondary">
								As a high-masking, gifted AuDHDer with a special interest in
								psychology, I became fluent in both autistic and non-autistic
								communication styles. I can help you navigate between worlds
						...
						<div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
							...
							<BodyBase className="text-text-secondary">
								My brain physically cannot handle unnecessary complexity. This
								limitation became my greatest strength—I instinctively break
								down overwhelming situations into their simplest, most
								manageable components. Often, I help problems disappear entirely
								by targeting their essence or revealing they weren't aligned
								with what truly matters. (Yes, I'm still learning to apply this
								to my own life. We teach what we most need to learn, right?)
							</BodyBase>
						</div>
						...
						<div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
							...
							<BodyBase className="text-text-secondary">
								My certification in Acceptance and Commitment Therapy gives me
								concrete tools for working with the anxiety, perfectionism, and
								identity challenges that come with late diagnosis.
							</BodyBase>
						</div>
						...
						<div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
							...
							<BodyBase className="text-text-secondary">
								As a professional software engineer with a side passion for
								building tools that make AuDHD life simpler, I bring a unique
								systems-thinking approach to coaching. I see patterns,
								connections, and elegant solutions where others see chaos.
							</BodyBase>
						</div>
						...
						<div className="bg-surface rounded-xl p-6 md:p-8 border border-border transition-shadow duration-200 hover:shadow-sm">
							...
							<BodyBase className="text-text-secondary">
								Those years of coaching before my diagnosis? They taught me that
								neurodivergent clients need something different. I was adapting
								my approach intuitively then. Now I do it intentionally.
							</BodyBase>
						</div>
					</div>
				</Container>
				...
				<Container>
					...
					<div className="text-left space-y-6">
						<BodyLarge className="font-semibold">
							I'm not here to help you become a better neurotypical. I'm here to
							help you become a more sustainable version of yourself.
						</BodyLarge>
						...
						<ul className="text-left space-y-3">
							...
							<li className="flex items-start space-x-3">
								<span className="text-primary mt-1">•</span>
								<BodyBase>
									Translating between your internal experience and the external
									world
								</BodyBase>
							</li>
							<li className="flex items-start space-x-3">
				...
				<Container>
					...
					<div className="space-y-6">
						<BodyBase>
							...
							you'll find me deep in a rabbit hole about the interactions
							between autism and ADHD, building software tools for
							neurodivergent minds, or having marathon video calls with my
							partner Olivia. She's AuDHD and gifted too, does autism testing in
							the US, and is simply the best human I know. We can spend hours
							dissecting theory of mind, neurodivergence intersections, and
							loving every minute of our nerdy deep dives.
						</BodyBase>
						<BodyBase>
							I live in Mexico City, where the chaos somehow makes sense to my
							AuDHD brain, and I maintain an embarrassing number of
